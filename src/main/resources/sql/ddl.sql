...
--DROP TABLE MangaApp.USER;
CREATE TABLE MangaApp.USER
(
...
(
    ...
    FOREIGN KEY (user_id) REFERENCES MangaApp.USER (id) ON DELETE CASCADE,
...
(
    ...
    release_year           smallint              DEFAULT 1814,
    ...
    FOREIGN KEY (translator_id) REFERENCES MangaApp.USER (id)
);
...
(
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (user_id) REFERENCES MangaApp.USER (id),
...
(
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (related_manga_id) REFERENCES MangaApp.MANGA (id) ON DELETE CASCADE,
    FOREIGN KEY (sender_id) REFERENCES MangaApp.USER (id) ON DELETE CASCADE
);
